Вот содержимое файла `README.md` на английском языке (так как это был последний контекст) в формате Markdown, который можно скопировать и вставить прямо в GitHub.

Если вам нужна русская версия в этом формате, пожалуйста, дайте знать.
